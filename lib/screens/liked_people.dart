...
class LikedPeople extends StatefulWidget {
  const LikedPeople({super.key});

  @override
  State<LikedPeople> createState() => _LikedPeopleState();
}

class _LikedPeopleState extends State<LikedPeople> {
  int isPro = 0;
  List<dynamic> users = [];
  ...
  void fetchDetails() async {
    ...
    final url = Uri.parse('https://materound.com/app/api/v1/profile/likes.php');
