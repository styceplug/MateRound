...
class DislikedPeople extends StatefulWidget {
  const DislikedPeople({super.key});

  @override
  State<DislikedPeople> createState() => _DislikedPeopleState();
}

class _DislikedPeopleState extends State<DislikedPeople> {
  int isPro = 0;
  List<dynamic> users = [];
  ...
  void fetchDetails() async {
    ...
    final url = Uri.parse('https://materound.com/app/api/v1/profile/disliked_me.php');
